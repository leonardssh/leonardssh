...
My name is Narcis (from **[Greek mythology]** 😄), known as 🦁 Leonard everywhere, and I'm an 19 y.o self-taught programmer born and raised in Romania. 🇷🇴 (currently I'm living in Spain. 🇪🇸)
...
### 👨‍💻 What I do
   ...
   * 💼 Open Source Projects
      ...
      - NeoVim Extensions: **[coc-discord-rpc]** - an awesome and fully customizable coc-extension to get Discord Rich Presence integration with **[NeoVim]**.
      - VS Code Extensions: **[vscord]** - another awesome and fully customizable VS Code extension to get Discord Rich Presence integration.
      - Automations: **[auto-github-bio]**, **[auto-twitter-bio]**, **[auto-discord-status]** - all this automatically updates your biography using **[openweathermap.org]** API
